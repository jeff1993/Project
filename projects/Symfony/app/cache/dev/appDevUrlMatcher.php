...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/a')) {
            // add
            if ($pathinfo === '/add') {
                return array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::addAction',  '_route' => 'add',);
            }

            // authorize
            if ($pathinfo === '/authorize') {
                return array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::authorizeAction',  '_route' => 'authorize',);
            }
        ...
        // create
        if ($pathinfo === '/create') {
            return array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::createAction',  '_route' => 'create',);
        }

        if (0 === strpos($pathinfo, '/group')) {
            // group
            if ($pathinfo === '/group') {
                return array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::groupAction',  '_route' => 'group',);
            }

            // groupadd
            if ($pathinfo === '/groupadd') {
                return array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::groupaddAction',  '_route' => 'groupadd',);
            }
        ...
        // managerepo
        if ($pathinfo === '/managerepo') {
            return array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::managerepoAction',  '_route' => 'managerepo',);
        }

        // repo
        if ($pathinfo === '/repo') {
            return array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::repoAction',  '_route' => 'repo',);
        }

        if (0 === strpos($pathinfo, '/s')) {
            // show
            if ($pathinfo === '/show') {
                return array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::showAction',  '_route' => 'show',);
            }

            // submitted
            if ($pathinfo === '/submitted') {
                return array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::submittedAction',  '_route' => 'submitted',);
            }
        ...
        // user
        if ($pathinfo === '/user') {
            return array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::userAction',  '_route' => 'user',);
        }

        // git_gui_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'git_gui_homepage')), array (  '_controller' => 'Git\\Bundle\\GuiBundle\\Controller\\DefaultController::indexAction',));
        }
